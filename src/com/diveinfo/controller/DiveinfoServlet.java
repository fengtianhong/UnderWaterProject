	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("insert".equals(action)) {
			...
			try {
				...
				diveinfoVO = diveinfoSvc.addDiveInfo(pointname, latitude, longitude, view, introduction,
						season.toString(), local, pic, 0, 0, "上架");
		...
		if ("changeStatus".equals(action)) {
			...
			try {
				...
				diveinfoVO = diveinfoSvc.updateDiveInfo(pointSN, diveinfoVO.getPointName(), diveinfoVO.getLatitude(), diveinfoVO.getLongitude(), diveinfoVO.getView(), diveinfoVO.getIntroduction(),
						diveinfoVO.getSeason(), diveinfoVO.getLocal(), diveinfoVO.getPic(), diveinfoVO.getRatePoint(), diveinfoVO.getRatePeople(), diveinfoVO.getStatus());
