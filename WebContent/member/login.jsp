                      	...
                      	<div id="register" class="animate form">
                            <form  autocomplete="on" action="member.do" onsubmit="checkform(this)" method="post"> 
								...
								<p> 
                                    ...
                                    <input id="Personid" name="personID" required="required" type="text" value="<%=(memberVO == null) ? "" : memberVO.getPersonID()%>" /> 
                                </p>
								<p> 
								...
								<p> 
                                    ...
                                    <input id="Birthdate" name="birthDate" required="required" type="date" value="<%=(memberVO == null) ? "" : memberVO.getBirthDate()%>" /> 
                                </p>
								<p> 
                                    <label for="Telephone">電話:</label>
                                    <input id="Telephone" name="phone" required="required" type="text" value="<%=(memberVO == null) ? "" : memberVO.getPhone()%>" /> 
                                </p>			
								<p> 
                                    <label for="Address">地址:</label>
                                    <input id="Address" name="address" required="required" type="text" value="<%=(memberVO == null) ? "" : memberVO.getAddress()%>" /> 
                                </p>
								<p> 
                                ...
                                <p class="change_link"> 已經是會員 ?
									<a href="#tologin" class="to_register"> 會員登入 </a>
								</p>
                            </form>
                        </div>
