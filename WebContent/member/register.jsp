...
<!--                         </div> -->
                      	...
                      	<div id="register" class="animate form">
                            <form  autocomplete="on" action="member.do" onsubmit="checkform(this)" method="post" enctype="multipart/form-data"> 
                                <h1> 會員註冊 </h1> 
                                <div style="text-align:center; color:red;"><c:if  test="${errorMsgs!=null}"> ${errorMsgs}</c:if></div>
                                <p> 
                                ...
                                <p class="change_link"> 已經是會員 ?
									<a href="login.jsp" class="to_register"> 會員登入 </a>
								</p>
                            </form>
                        </div>
