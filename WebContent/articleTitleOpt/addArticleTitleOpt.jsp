...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/articleTitleOpt/articleTitleOpt.do" name="form1">
    <table id = "addtitle">
        <tr>
        ...
        <tr>
            <td>
            	<input type="text" name="TitleText" size="36" value="<%= (articleTitleOptVO==null)? "新增標題" : articleTitleOptVO.getArticleTitleOptText()%>" />
            </td>
        	<td>
