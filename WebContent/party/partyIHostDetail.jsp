...
<!-- 待測試 -->
	<button type="button" onclick="<%=request.getContextPath()%>/party/partyIHost.jsp">回上頁(測試button連結)</button>
	<input type="button" onclick="history.back()" value="回上頁" class="btn btn-outline-info btn-sm">
	<button type="submit" name="action" value="submitUpdate" class="btn btn-outline-info btn-sm">確認修改</button>
</form>
</section>
