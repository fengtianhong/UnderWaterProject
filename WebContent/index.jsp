            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">潛水地圖</h4>
                        <p class="text-muted">是否在為了下一次的冒險目的籌畫呢？給您地圖式的搜尋，快速找到心動的潛水點。</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="img/portfolio/suit.jpg" alt="..." />
                            </a>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                                ...
                                <img class="img-fluid" src="img/portfolio/watch.jpg" alt="..." />
                            </a>
                            <div class="portfolio-caption">
...
%>
        <section class="page-section" id="about">
            <div class="container">
                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="img/about/party1.jpg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                         		<h4>揪團編號 <%=partyList.get(0).getPartySN()%></h4>
                                <h4 class="subheading"><%=partyList.get(0).getPartyTitle()%></h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted"><%=partyList.get(0).getPartyDetail()%></p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="img/about/party2.jpg" alt="..." /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>揪團編號 <%=partyList.get(1).getPartySN()%></h4>
                                <h4 class="subheading"><%=partyList.get(1).getPartyTitle()%></h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted"><%=partyList.get(1).getPartyDetail()%></p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <a href="party/party.do?action=party"><h4 style="color:white">更多揪團<br>就等你來</h4></a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">TFA101 第5組 UNDERWATER 在水之下</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="/img/portfolio/suit.jpg" alt="..." />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <h2 class="text-uppercase">Project Name</h2>
                                    <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                                    <img class="img-fluid d-block mx-auto" src="../assets/img/portfolio/watch.jpg" alt="..." />
                                    <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                                    <ul class="list-inline">
                                        <li>
                                            <strong>Client:</strong>
